...
def model_run(
             file_name, activation='tanh', lr= 0.001, dropout=0.5,
    ...
    model = create_model(activation=activation, lr=lr_schedule, 
...
if __name__ == "__main__":
    ...
    ap.add_argument("-lr", "--lr", type=int, default=0.001, help="Learning Rate")
